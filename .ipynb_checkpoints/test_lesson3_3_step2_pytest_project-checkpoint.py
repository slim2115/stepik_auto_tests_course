...
# Переписываем в стиле unittest тест для страницы http://suninjuly.github.io/registration1.html
class test_class_name(unittest.TestCase):
    def test_class_name1(self):
# Оформляем финальные проверки в тестах в стиле pytest, например, используя проверочный метод assertEqual
...
# Оформите финальные проверки в тестах в стиле pytest, например, используя проверочный метод assertEqual
        self.assertEqual
        "Congratulations! You have successfully registered!" == welcome_text
